...
class MalayamAlbum extends StatefulWidget {
  const MalayamAlbum({super.key});

  @override
  State<MalayamAlbum> createState() => _MalayamAlbumState();
}

class _MalayamAlbumState extends State<MalayamAlbum> {
  @override
