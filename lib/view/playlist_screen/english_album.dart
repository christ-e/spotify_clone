...
class EnglishAlbum extends StatefulWidget {
  const EnglishAlbum({super.key});

  @override
  State<EnglishAlbum> createState() => _EnglishAlbumState();
}

class _EnglishAlbumState extends State<EnglishAlbum> {
  @override
