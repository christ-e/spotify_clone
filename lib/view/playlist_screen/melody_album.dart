...
class MelodyAlbum extends StatefulWidget {
  const MelodyAlbum({super.key});

  @override
  State<MelodyAlbum> createState() => _MelodyAlbumState();
}

class _MelodyAlbumState extends State<MelodyAlbum> {
  @override
